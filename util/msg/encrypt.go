...
import (
	...
	"errors"
	"fmt"
	"github.com/chenghuama/tencent/weixin/mp/model"
	"github.com/chenghuama/util"
	"strconv"
	"time"
)
...
func (this *WXBizMsgCrypt) EncryptMsg(sReplyMsg, sTimeStamp, sNonce string) (string, error) {
	//加密待发送的消息
	encrypt, err := this.encrypt(sReplyMsg)
	if err != nil {
		return "", err
	}
	//生成安全签名
